...
const Dashboard = () => {
  ...
  const commitAction = (action, id) => {
    ...
    if (action.toLowerCase() === "remove") {
      const removedAppointment = appointments.filter(
        (app) => app.id !== id + 1,
      );
  ...
  //todo list functionality, just wanted to indicate

  const addItem = (form) => {
    console.log(form);
    setAppointments((prevData) => {
      const newId =
        prevData.reduce((maxId, item) => Math.max(maxId, item.id), 0) + 1;
      ...
      <div className="main-container">
                    ...
                    <td className="patient">
                      <div className="flex flex-row gap-2 items-center patient-wrapper">
                        <div
                          ...
                          style={{
                            backgroundColor: randomizeBackgroundColor(),
                          }}
                        >
        ...
        <div className="pagination flex items-center justify-between">
          ...
          >
            ...
            >
              <path
                d="M0.750163 4.08333L3.52794 0.75M0.750163 4.08333L3.52794 7.41667M0.750163 4.08333L9.0835 4.08333"
                stroke="#24AE7C"
                stroke-width="1.5"
          ...
          >
            ...
            >
              <path
                d="M9.08333 4.08333L6.30556 0.75M9.08333 4.08333L6.30556 7.41667M9.08333 4.08333L0.75 4.08333"
                stroke="#24AE7C"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
